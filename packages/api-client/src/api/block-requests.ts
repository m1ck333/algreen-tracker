...
export const blockRequestsApi = {
  getAll(params: { tenantId: string; status?: RequestStatus; search?: string; page?: number; pageSize?: number; createdFrom?: string; createdTo?: string; sortBy?: string; sortDirection?: string }) {
